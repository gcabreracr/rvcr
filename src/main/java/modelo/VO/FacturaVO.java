...
public class FacturaVO {
    ...
    private String consecutivo_fe;
    private String clave_fe;
    ...
    public String getConsecutivo_fe() {
        return consecutivo_fe;
    }

    public void setConsecutivo_fe(String consecutivo_fe) {
        this.consecutivo_fe = consecutivo_fe;
    }

    public String getClave_fe() {
        return clave_fe;
    }

    public void setClave_fe(String clave_fe) {
        this.clave_fe = clave_fe;
    }
