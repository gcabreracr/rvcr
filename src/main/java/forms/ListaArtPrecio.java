...
public class ListaArtPrecio extends javax.swing.JDialog {

    public String valorRetorno;
    DefaultTableModel dtmArticulos;
    FiltrarTablas filtraTabla;

    public ListaArtPrecio(java.awt.Frame parent, boolean modal) throws SQLException {
        super(parent, modal);
        initComponents();
    ...
    private void initComponents() {
        ...
        setTitle("Lista articulos x categoria");
        ...
        if (jtArticulos.getColumnModel().getColumnCount() > 0) {
            ...
            jtArticulos.getColumnModel().getColumn(0).setPreferredWidth(15);
            ...
            jtArticulos.getColumnModel().getColumn(2).setPreferredWidth(25);
        }
