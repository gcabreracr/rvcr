 ...
 * 
 */
public class BuscaClienteActivo extends javax.swing.JDialog {
    ...
    public BuscaClienteActivo(java.awt.Frame parent, boolean modal) throws SQLException {
        super(parent, modal);
        initComponents();
    ...
    private void initComponents() {
        ...
        setTitle("Busqueda Cliente Comercial (Actvos)");
    ...
    private void txtCodAgeActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_txtCodAgeActionPerformed
        ...
        try {
            ...
            Logger.getLogger(BuscaClienteActivo.class.getName()).log(Level.SEVERE, null, ex);
        }
    ...
    private void llenarTabla() throws SQLException {
       ...
       // jtClientes=new JTable();       
        ...
        ArrayList<ClienteVO> listaClientes = ClienteDAOImpl.listarClientesActivos(age, pdv);
